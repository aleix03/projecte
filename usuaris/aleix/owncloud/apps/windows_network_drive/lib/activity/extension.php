...
class Extension implements IExtension {
	const APP_NAME = 'windows_network_drive';

	const TYPE_FILE_UPDATED = 'wnd_file_updated';
	const TYPE_FILE_REMOVED = 'wnd_file_removed';
	const TYPE_FILE_RENAMED = 'wnd_file_renamed';

	const SUBJECT_FILE_UPDATED = 'file_updated';
	const SUBJECT_FILE_REMOVED = 'file_removed';
	const SUBJECT_FILE_RENAMED = 'file_renamed';
